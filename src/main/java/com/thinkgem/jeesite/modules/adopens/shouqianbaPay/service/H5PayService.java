package com.thinkgem.jeesite.modules.adopens.shouqianbaPay.service;

import com.alibaba.fastjson.JSON;
import com.alibaba.fastjson.JSONObject;
import com.thinkgem.jeesite.modules.adopens.shouqianbaPay.constants.Constants;
import com.thinkgem.jeesite.modules.adopens.shouqianbaPay.entity.H5PayReqData;
import com.thinkgem.jeesite.modules.adopens.shouqianbaPay.entity.H5PayResData;
import com.thinkgem.jeesite.modules.adopens.shouqianbaPay.utils.HttpUtil;
...
public class H5PayService {
	...
	public static void main(String[] args) {
		...
		try {
			H5PayReqData h5PayReqData = new H5PayReqData(Constants.MERCHANT_NO,Constants.MERCHANT_SECRET, payMethod,
					orderNo, amount, subject,limitPay, notifyUrl, userId,expireTime);
