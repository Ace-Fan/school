...
<body>
	...
	<form:form id="inputForm" modelAttribute="menu" action="${ctx}/sys/menu/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="name" htmlEscape="false" maxlength="50" class="required input-xlarge formInput"/>
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="href" htmlEscape="false" maxlength="2000" class="input-xxlarge formInput"/>
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="target" htmlEscape="false" maxlength="10" class="input-small formInput"/>
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="sort" htmlEscape="false" maxlength="50" class="required digits input-small formInput"/>
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="permission" htmlEscape="false" maxlength="100" class="input-xxlarge formInput"/>
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:textarea path="remarks" htmlEscape="false" rows="3" maxlength="200" class="input-xxlarge formInput"/>
			</div>
		</div>
