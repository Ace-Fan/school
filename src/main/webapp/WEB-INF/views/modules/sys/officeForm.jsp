...
<body>
	...
	<form:form id="inputForm" modelAttribute="office" action="${ctx}/sys/office/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="code" htmlEscape="false" maxlength="50" cssClass="formInput" />
			</div>
		</div>
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:select path="type" class="input-medium formSelect">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:select path="grade" class="input-medium formSelect">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="address" htmlEscape="false" maxlength="50" cssClass="formInput"/>
			</div>
		</div>
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="zipCode" htmlEscape="false" maxlength="50" cssClass="formInput" />
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">负责人:</label>
			<div class="controls">
				<form:input path="master" htmlEscape="false" maxlength="50" cssClass="formInput" />
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">电话:</label>
			<div class="controls">
				<form:input path="phone" htmlEscape="false" maxlength="50" cssClass="formInput" />
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">传真:</label>
			<div class="controls">
				<form:input path="fax" htmlEscape="false" maxlength="50" cssClass="formInput" />
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">邮箱:</label>
			<div class="controls">
				<form:input path="email" htmlEscape="false" maxlength="50" cssClass="formInput" />
			</div>
		</div>
		<div class="control-group">
