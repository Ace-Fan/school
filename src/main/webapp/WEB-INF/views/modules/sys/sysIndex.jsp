	...
	<div id="main">
		<div id="header" class="navbar navbar-fixed-top">
			<div class="navbar-inner">
				...
				<ul id="userControl" class="nav pull-right">
					<li style="margin-top: 17px;color:white;"><span>${fns:getUser().office.name}</span></li>
	    ...
	    <div class="container-fluid">
		    ...
		    <div id="footer" class="row-fluid">
	            Copyright &copy; 2019-${fns:getConfig('copyrightYear')} ${fns:getConfig('productName')} <%--- Powered By adopens ${fns:getConfig('version')}--%>
			</div>
		</div>
	</div>
	<script type="text/javascript"> 
