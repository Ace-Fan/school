package com.thinkgem.jeesite.modules.adopens.shouqianbaPay.controller;

import com.alibaba.fastjson.JSON;
import com.alibaba.fastjson.JSONObject;
import com.thinkgem.jeesite.modules.adopens.shouqianbaPay.entity.*;
...
public class DemoPayController {
	...
	public String H5PayNow(HttpServletRequest request) throws Exception {
		...
		if (limitPay.equals("TRUE")) {
			...
			limitPay = "no_credit";
		H5PayReqData h5PayReqData = new H5PayReqData(merchantNo, md5Key, payMethod, orderNo, amount, subject, limitPay,
				notifyUrl, userId,expireTime);
