	...
	<form:form id="inputForm" modelAttribute="role" action="${ctx}/sys/role/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls">
				...
				<form:input path="enname" htmlEscape="false" maxlength="50" class="required formInput"/>
		...
		<div class="control-group">
			...
			<div class="controls"><%--
				...
				<form:select path="roleType" class="input-medium formSelect">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:select path="dataScope" class="input-medium formSelect">
