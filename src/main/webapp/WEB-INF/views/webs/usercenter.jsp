			...
			<div class="am_content_kjdt_nr">
				...
				<div style="padding-top:10px;"><span style="padding-left:10px;font-size:16px;color:#fff;font-weight:bold;">${nickname}</span>
					<div style="height:30px;">
						...
						<div class="am-u-sm-6 am_center_jifen" style="color:#fff;">积分:${currIntegral}</div>
					</div>
				</div>
			</div>
		</div>
			...
			<div class="am_center_pet_grzx_nr1">
				<div class="am_center_kjdt_block">
					...
					<div class="am-u-sm-6" >
						...
						<div style="width:200px;"><span style="padding-left:10px;font-size:12px;">累计收入</span>
					...
					<div class="am-u-sm-6">
						<div class="am_incomde_ico"><img style="width: 20px;height: 20px;" src="${ctxStatic}/webs/img/balance.png" alt=""></div>
						<div style="width:200px;"><span style="padding-left:10px;font-size:12px;">余额</span>
							<div style="height:30px;width:200px;">
								<div class="am-u-sm-12 am_center_income_etc">￥${currAmount}</div><span class="hd_tag_tixian" style="border:1px solid red;position: relative;left:-20px;top:-1px;font-size: 10px;" onclick="javascript:window.location.href='${pageContext.request.contextPath}/f/webs/usercenter/myBalanceDetail'">明细</span>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="am-u-sm-6">
					<div class="am_incomde_ico"><img style="width: 20px;height: 20px;" src="${ctxStatic}/webs/img/visa.png" alt=""></div>
					<div style="width:200px;"><span style="padding-left:10px;font-size:12px;">可提现金额<button data-am-modal="{target:'#help_one', closeViaDimmer: 0, width: 300, height: 200}"  style="background:url(${ctxStatic}/webs/img/helpnew.png);border-style:none;width:12%; height:23px; background-repeat:no-repeat;position: relative;left:3px;top:-3px;"></button></span>
						<div style="height:30px;">
							<div class="am-u-sm-12 am_center_income_etc">￥
								<c:if test="${allowTixianAmount!='null'}">${allowTixianAmount}</c:if>
								<c:if test="${allowTixianAmount=='null'}">0.00</c:if>
								</div><span class="hd_tag_tixian" style="border:1px solid red;position: relative;left:-20px;top:-1px;font-size: 10px;" onclick="javascript:window.location.href='${pageContext.request.contextPath}/f/webs/usercenter/withdrawal'">提现</span>
						</div>
					</div>
				</div>
				...
				<div class="am-u-sm-6">
					...
					<div style="width:200px;"><span style="padding-left:10px;font-size:12px;">我的红包<button data-am-modal="{target:'#help_two', closeViaDimmer: 0, width: 300, height: 200}"  style="background:url(${ctxStatic}/webs/img/helpnew.png);border-style:none;width:12%; height:23px; background-repeat:no-repeat;position: relative;left:3px;top:-3px;"></button></span>
						<div style="height:30px;">
							<div class="am-u-sm-12 am_center_income_etc" style="width:150px;">￥${currWallet}<span style="margin-left:3px;font-size:10px;font-weight:normal;">${statusWallet}</span></div>
						</div>
					</div>
				</div>
			</div>
		...
		<div>
			<div class="am_center_grzx">
				<div class="am_center_pet_grzx_nr11 ">
					...
					<div class="am-u-sm-4" onclick="javascript:window.location.href='${pageContext.request.contextPath}/f/webs/usercenter/myFufen'">
						<div class="am_incomde_ico1"><img src="${ctxStatic}/webs/img/follower.png" alt=""></div>
						<div style="text-align: center;">
							<span style="padding-left:0px;font-size:12px;white-space: nowrap;">我的福粉</span>
						</div>
					</div>
				</div>
			</div>
		...
		<div >
			<div class="am_center_grzx">
				<div class="am_center_grzx_nr" >
					...
					<div>
						<div class="am-u-sm-1" >
							<div class="am_incomde_ico"><img src="${ctxStatic}/webs/img/scarf.png" alt=""></div>
						</div>
						<div class="am-u-sm-11" style="padding: 0px;margin:0px;white-space: nowrap;overflow: auto;">
							<div style="padding-left:0px;"><span style="padding-left:0px;font-size:16px;">恭喜您荣升钻石创客，开启您0元创业之路！拥有健康、美丽、财富!</span></div>
						</div>
					</div>
					</c:if>
					...
					<div>
						...
						<div class="am-u-sm-11" style="padding: 0px;margin:0px;white-space: nowrap;overflow: auto;">
							<div><span style="font-size:16px;">恭喜您获得299元红包,请在我的礼品金里进行查收!</span></div>
						</div>
					</div>
					</c:if>
					...
					<div>
						...
						<div class="am-u-sm-11" style="padding: 0px;margin:0px;white-space: nowrap;overflow: auto;">
							<div><span style="font-size:16px;">恭喜您获赠1000积分,请注意查收！</span></div>
						</div>
					</div>
					</c:if>
					...
					<div>
						...
						<div class="am-u-sm-11" style="padding: 0px;margin:0px;white-space: nowrap;overflow: auto;">
							<div><span style="font-size:16px;">恭喜您获赠黑科技.高能腰管家一条,请注意查收！收货地址为您的默认地址。</span></div>
						</div>
					</div>
					</c:if>
