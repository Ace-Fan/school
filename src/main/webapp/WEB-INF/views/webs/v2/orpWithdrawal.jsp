...
<div style="text-align: center;">
        ...
        <span class="txtmargin">电话</span><input type="text" name="phone" placeholder="请输入手机号码" value="${wa.phone}" class="login-password"><br/>
        ...
        元</span><input type="button" onclick="javascript:window.location.href='${pageContext.request.contextPath}/f/webs/usercenter/orpWithdrawalDetail'" class="yzm-hq1" style="position: relative;width:100px;float:right;right:5%;" value="提现记录" />
...
<script>
    ...
    function doSubmit() {
       ...
       /* if (reqMoney < 50) {
        ...
        $("#id_my-confirm_text").text("确定发起本金提现吗？");
        $('#my-confirm').modal({
            relatedTarget: this,
            onConfirm: function(options) {
                if (flag1 == 0) {
                    flag1 = 1;
                    var url = "${pageContext.request.contextPath}/f/webs/usercenter/reqOrpWithdrawal";
