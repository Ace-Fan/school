	...
	<div>
		<div class="am_center_grzx">
			<div class="am_center_pet_grzx_nr1">
				...
				<div class="am_center_kjdt_block" style="margin-bottom: 10px;">
					<div class="am-u-sm-6" style="height:90px;">
						<div style="width:200px;"><span style="padding-left:10px;font-size:14px;">累计收入</span>
							<div style="height:30px;width:200px;">
					...
					<div class="am-u-sm-6" style="height:110px;">
						<div style="width:200px;">
							<div style="width:200px;"><span style="padding-left:10px;font-size:14px;">经销收入</span>
								<div style="height:30px;width:200px;">
									<div class="am-u-sm-12 am_center_income_etc">￥${jxAmountSum}</div>
								</div>
							</div>
							<div style="width:200px;"><span style="padding-left:10px;font-size:14px;">零售收入</span>
								<div style="height:30px;width:200px;">
									<div class="am-u-sm-12 am_center_income_etc">￥${lsAmountSum}</div>
								</div>
							</div>
						</div>
					</div>
				...
				<div class="am_center_kjdt_block" style="margin-bottom: 10px;">
					<div class="am-u-sm-6" style="height:90px;">
						...
						<div style="width:200px;"><span style="padding-left:10px;font-size:14px;">余额</span>
							...
							<div style="height:30px;width:200px;">
								<div class="am-u-sm-12 am_center_income_etc"><span class="hd_tag_tixian" style="border:1px solid red;position: relative;left:0px;top:-1px;font-size: 12px;" onclick="javascript:window.location.href='${pageContext.request.contextPath}/f/webs/usercenter/myBalanceDetail'">明细</span></div>
							</div>
						</div>
					</div>
					<div class="am-u-sm-6" style="height:90px;">
						<div class="am_incomde_ico"><img style="width: 20px;height: 20px;" src="${ctxStatic}/webs/v2/img/ktxje.png" alt=""></div>
						<div style="width:200px;"><span style="padding-left:10px;font-size:14px;">可提现金额<button data-am-modal="{target:'#help_one', closeViaDimmer: 0, width: 300, height: 200}"  style="background:url(${ctxStatic}/webs/img/helpnew.png);border-style:none;width:12%; height:23px; background-repeat:no-repeat;position: relative;left:3px;top:3px;"></button></span>
							<div style="height:30px;width:200px;">
								<div class="am-u-sm-12 am_center_income_etc">￥
							...
							<div style="height:30px;width:200px;">
								<div class="am-u-sm-12 am_center_income_etc" style="width: 150px;"><span class="hd_tag_tixian" style="border:1px solid red;position: relative;left:0px;top:-1px;font-size: 12px;width: 60px;" onclick="javascript:window.location.href='${pageContext.request.contextPath}/f/webs/usercenter/toKtxChangeOverToJhAmount'">转预存款</span><span class="hd_tag_tixian" style="border:1px solid coral;position: relative;left:0px;top:-1px;font-size: 12px;margin-left: 4px;color: coral;" onclick="javascript:window.location.href='${pageContext.request.contextPath}/f/webs/usercenter/withdrawal'">提现</span></div>
							</div>
						</div>
					</div>
				</div>
