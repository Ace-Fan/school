	...
	<div style="margin-left: 1rem;">
		<div class="layui-inline" style="margin-top: 0.5rem;">
			<form id="selectDiv">
				...
				<input type="text" placeholder="请输入评分类型编码" id="code" autocomplete="off" class="layui-input" maxlength="20" >
				</div>
				<div class="layui-inline layui-form selectDiv-input">
					<input type="text" placeholder="请输入评分类型名称" id="name" autocomplete="off" class="layui-input" maxlength="20" >
				</div>
				<div class="layui-inline layui-form selectDiv-input">
