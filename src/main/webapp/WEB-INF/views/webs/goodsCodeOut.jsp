...
<div style="width:100%;text-align:center;margin-top:100px;">
	...
	<div id="scanQRCode" style="background-color:#47033a;height:200px;width:200px;border-radius:100px;line-height:200px;color:#fff;margin:0 auto">
		<b>出 库</b>
	</div>
    ...
    $("#scanQRCode").click(function() {
        wx.scanQRCode({
            ...
            success : function(res) {
				...
				var postUrl = "${pageContext.request.contextPath}/f/webs/goodsCode/outData";
				var para = {
                    codes : codes,
					openid : $("#openid").val(),
                    orderNo : $("#orderNo").val()
